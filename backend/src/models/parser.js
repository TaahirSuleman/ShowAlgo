...
class Parser {
  ...
  parseVariableDeclaration() {
    console.log(`parseVariableDeclaration at line ${this.currentToken().line}`);
    this.expect("Keyword", "set");
    const varName = this.consume("Identifier").value;
    this.expect("Keyword", "to");
    const value = this.parseExpression();
    return new VariableDeclaration(varName, null, value);
  }
  ...
  parseFunctionDeclaration() {
    console.log(`parseFunctionDeclaration at line ${this.currentToken().line}`);
  ...
  parseValue() {
    const token = this.currentToken();
    console.log(`parseValue: ${token.value} at line ${token.line}`);
